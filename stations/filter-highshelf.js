...
export function mount(container, { audioEngine, accent }) {
  container.innerHTML = `
    ...
    <canvas class="spectrum-canvas" id="hs-filter-canvas" width="600" height="200"
      role="img" aria-label="Live filter response curve — the exact shape this filter is applying right now"></canvas>
    <div class="spectrum-axis" id="hs-filter-axis"></div>
  ...
  const filterCanvas = container.querySelector("#hs-filter-canvas");
  const filterAxisEl = container.querySelector("#hs-filter-axis");
